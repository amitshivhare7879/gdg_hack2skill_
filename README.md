...
- Creates the SQLite database (`civic_rank.db`)
...
| `DATABASE_URL` | `sqlite:///./civic_rank.db` | SQLAlchemy database URL |
...
2. Set a **Space name** (e.g. `civic-rank-ai`).
